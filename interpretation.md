...
Download this (1-2MB) [file system image](http://web.cs.ucla.edu/classes/spring18/cs111/projects/EXT2_test.img), and mount it (read only) onto your own Linux system, with the following commands:
